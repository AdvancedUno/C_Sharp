...
namespace Frism_Inspection_Renew.Utils
{
    public class Utils
    {
        ...
        public static void Saving()
        {
            ...
            {
                saveFolderPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\INTELLIZ Corp\\Frism Inspection";
                System.Windows.Forms.MessageBox.Show("Temporary Path has been Assigned. Please Select a Folder First. Path: " + saveFolderPath);
